...
const productSchema = new mongoose.Schema(
  {
    ...
    costPrice: { type: Number },                 // optional
unit: { type: String, default: "pcs" },      // matches UI dropdown
reorderLevel: { type: Number, default: 9 },  // optional; 0 means “no reorder alert” if you want
description: { type: String, default: "" },  // keep but make consistent
...
productSchema.pre("findOneAndUpdate", function (next) {
  ...
  // write back (handles both styles)
